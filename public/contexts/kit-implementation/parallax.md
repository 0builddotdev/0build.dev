...
To apply this component, add the `data-z-parallax` attribute to any element. Use one of the following options to animate the corresponding CSS property.
...
```html
<div data-z-parallax="bgy: -200">…</div>
```

```html
<div
  class="display-flex h bg-cover bg-image"
  data-z-parallax="bgy: -200"
  style="
    --h: 80;
    --bg-image: url(&quot;https://0build.dev/images/dark.jpg&quot;);
  "
>
  <h1
    class="z-h1 z-margin-auto-vertical mx-auto w text-center color"
...
```html
<div data-z-parallax="opacity: 0,1">…</div>
```

```html
<div
  class="z-overflow-hidden display-flex h bg-cover bg-image"
  style="
    --h: 80;
    --bg-image: url(&quot;https://0build.dev/images/dark.jpg&quot;);
  "
>
  <div
    class="z-margin-auto-vertical m-auto w text-center color"
    style="--w: 50%; --color: var(--color-white)"
  >
    <h1
      class="z-h1"
      data-z-parallax="opacity: 0,1; y: -100,0; scale: 2,1; end: 50vh + 50%;"
    >
      Headline
    </h1>
    <p
      class="mt"
      data-z-parallax="opacity: 0,1; y: 100,0; scale: 0.5,1; end: 50vh + 50%;"
      style="--mt: 4"
    >
...
```html
<div data-z-parallax="x: 0,50,150">…</div>
```
...
>
  ...
  >
    <h1
      class="z-h1"
      data-z-parallax="opacity: 0,1,1; y: -100,0,0; x: 100,100,0; scale: 2,1,1; end: 50vh + 50%;"
    >
      Headline
    </h1>
    <p
      class="mt"
      data-z-parallax="opacity: 0,1,1; y: 100,0,0; x: -100,-100,0; scale: 0.5,1,1; end: 50vh + 50%;"
      style="--mt: 4"
    >
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
      tempor incididunt ut labore et dolore magna aliqua.
...
```html
<div data-z-parallax="x: 0,50 10%,150 50%">…</div>
```
...
>
  <div
    class="z-margin-auto-vertical mx-auto w text-center color"
    style="--w: 50%; --color: var(--color-white)"
  >
    <h1
      class="z-h1"
...
```html
<div data-z-parallax="bgx: -50">
    <div data-z-parallax="x: -100, 100">…</div>
</div>
```
...
```html
<div id="target">
    <div data-z-parallax="target: #target">…</div>
</div>
```
...
>
  <h1
    class="z-h1 z-margin-auto-vertical mx-auto w text-center color"
    data-z-parallax="target: #test-target; y: 100,0"
    style="--w: 50%; --color: var(--color-white)"
  >
    Headline
  </h1>
...
```html
<div data-z-parallax="start: 100%; end: 100%;">…</div>
<div data-z-parallax="start: 30vh; end: 30vh;">…</div>
<div data-z-parallax="start: 100% + 100; end: 100% + 100;">…</div>
```
...
>
  <div class="mx display-inline-flex gap" style="--mx: auto; --gap: 4">
    <div>
      <div
        class="bg p color"
        data-z-parallax="target: #test-start-end; y: 398; easing: 0;"
    ...
    <div>
      <div
        class="bg p color"
        data-z-parallax="target: #test-start-end; start: 100%; end: 100%; y: 398; easing: 0;"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        100% / 100%
      </div>
    ...
    <div>
      <div
        class="bg p color"
        data-z-parallax="target: #test-start-end; start: 30vh; end: 30vh; y: 398; easing: 0;"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        30vh / 30vh
      </div>
    ...
    <div>
      <div
        class="bg p color"
        data-z-parallax="target: #test-start-end; start: 100% + 100; end: 100% + 100; y: 398; easing: 0;"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        100% + 100 / 100% + 100
      </div>
...
>
  <div class="m-auto display-inline-flex gap" style="--gap: 4">
    <div>
      <div
        class="bg/o p color"
        data-z-parallax="target: #test-easing; start: 100%; end: 100%; y: 200; easing: -2"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        -2
      </div>
    ...
    <div>
      <div
        class="bg/o p color"
        data-z-parallax="target: #test-easing; start: 100%; end: 100%; y: 200; easing: -1"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        -1
      </div>
    ...
    <div>
      <div
        class="bg/o p color"
        data-z-parallax="target: #test-easing; start: 100%; end: 100%; y: 200; easing: -0.5"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        -0.5
      </div>
    ...
    <div>
      <div
        class="bg/o p color"
        data-z-parallax="target: #test-easing; start: 100%; end: 100%; y: 200; easing: 0"
        style="--bg: #fff; --p: 4; --color: #000"
      >
        0
      </div>
...
```html
<div data-z-parallax="border-color: #00f,#f00">…</div>
```

```html
<div
  id="test-color"
  class="test-color z-overflow-hidden display-flex h"
  data-z-parallax="start: 100%; end: 100%; background-color: yellow,white; border-color: #00f,#f00;"
  style="border: 10px solid #000; --h: 80"
>
  <h1
    class="z-h1 m-auto w text-center color"
    data-z-parallax="target: #test-target; start: 100%; end: 100%; color: #0f0;"
    style="--w: 50%; --color: var(--color-white)"
  >
    Headline
  </h1>
...
```html
<div data-z-parallax="blur: 10; sepia: 100;">…</div>
```
...
<div
  id="test-filter"
  class="z-overflow-hidden display-flex h bg-cover bg-image"
  data-z-parallax="start: 100%; end: 100%; sepia: 100;"
  style="
    --h: 80;
    --bg-image: url(&quot;https://0build.dev/images/light.jpg&quot;);
  "
>
  <h1
    class="z-h1 m-auto w text-center"
    data-z-parallax="target: #test-filter; start: 100%; end: 100%; blur: 0,10;"
    style="--w: 50%"
  >
    Headline
  </h1>
...
<div
  ...
  data-z-parallax="start: 100%; end: 100%; stroke: 100%;"
>
  <img src="/images/strokes.svg" width="250" height="250" alt="" data-z-svg />
</div>
```
...
<svg viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
    <rect x="0" y="0" width="10" height="10" data-z-parallax="rotate: 360"/>
</svg>
```
...
```html
<div data-z-parallax="media: @m"></div>
```
...
```js
zUIkit.parallax(element, options);
```