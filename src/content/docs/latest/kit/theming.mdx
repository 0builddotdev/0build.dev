...
<Alert status="info" icon="info">
  {
    <p>
      We extensively use multipliers to control certain elements and keep them
      in sync, so you only need to update a few variables. However, you're free
      to leave them as they are and implement your own theme values.
    </p>
  }
</Alert>
