...
The Breadcrumb component consists of links, which are aligned side by side and separated by a divider. Add the `.z-breadcrumb` class to a `<ul>` element to define the component. Use `<a>` elements as breadcrumb items within the list. An active state is automatically applied to the last `<li>` element.
...
<nav aria-label="Breadcrumb">
  <ul class="z-breadcrumb">
    ...
    <li class="z-disabled"><a>Disabled Category</a></li>
    <li>
      <span aria-current="page">0build</span>
    </li>
  </ul>
</nav>
```
