...
>
    <div class="display-flex gap-x" style="--gap-x: 2">
        ...
        ></z-icon>
        <div>
            <p>Text utilities <code class="font-medium">z-text-2xsmall</code> to <code class="font-medium">z-text-3xlarge</code> use a <code class="font-medium">1.25</code> modular scale ratio.</p>
        </div>
    </div>
</div>
