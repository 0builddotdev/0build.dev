...
>
    <div class="display-flex gap-x" style="--gap-x: 2">
        ...
        ></z-icon>
        <div>
            <p>The automatic cleanup relies on the class prefix. When switching from <code class="font-semibold">z-radius-sharp</code> to <code class="font-semibold">z-radius-rounded</code>, the component sees the shared <code class="font-semibold">z-radius-</code> prefix and smoothly removes the old class before attaching the new one.</p>
        </div>
    </div>
</div>
