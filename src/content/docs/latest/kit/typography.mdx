...
<Alert status="info" icon="info">
  {
    <p>
      Text utilities <code class="font-medium">z-text-2xsmall</code> to{" "}
      <code class="font-medium">z-text-3xlarge</code> use a{" "}
      <code class="font-medium">1.25</code> modular scale ratio.
    </p>
  }
</Alert>
