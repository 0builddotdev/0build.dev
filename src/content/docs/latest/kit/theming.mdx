...
context: https://0build.dev/contexts/kit-implementation/theming.md
---
...
>
    <div class="display-flex gap-x" style="--gap-x: 2">
        ...
        ></z-icon>
        <div>
            <p>We extensively use multipliers to control certain elements and keep them in sync, so you only need to update a few variables. However, you're free to leave them as they are and implement your own theme values.</p>
        </div>
    </div>
</div>
