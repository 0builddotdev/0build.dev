...
- Tons of bug fixes. No breaking changes are expected.
- Updated the [`background-image`](/docs/latest/style/background-image#adding-a-linear-gradient) documentation with a proper guide to creating different gradients.

## August 21, 2026

**v0.6.4** (upgradable to `v0.6.12`)
...
- Introducing [Playground](https://play.0build.dev/playground) - Distraction-free HTML playground that stays out of your way. Enjoy a floating editor, realtime preview, autosave, and instant downloads.
